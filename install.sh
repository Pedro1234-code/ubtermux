...
# Change the Ubuntu version here. Default is 20.04 Focal Fossa. This script does not support installation of Ubuntu versions launched before 2016 LTS. To install Ubuntu 16.04, put 16.04.6, not only 16.04.
